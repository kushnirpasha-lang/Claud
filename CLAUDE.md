...
- **Режим:** ТОЛЬКО отправка в Избранное (`send_message('me', ...)`) — никаких других чатов, контактов, диалогов
- **Запрещено навсегда:** отправка кому-либо кроме 'me', чтение любых сообщений, авто-ответы
- **Re-авторизация:** через workflow `tg-check.yml` → step=request → код → step=signin + 2FA

## Правила (ОБЯЗАТЕЛЬНО соблюдать)
1. **Telethon — ТОЛЬКО Избранное (`me`). Никаких контактов, никаких других чатов. Никогда.**
2. **Не читать чужие сообщения, не отвечать автоматически**
