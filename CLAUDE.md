...
## HairLove — Контекст бренда (всегда актуален)

Этот раздел читается при каждом старте. Когда используется любой `/hairlove-*` агент — этот контекст уже загружен, не нужно ничего запрашивать дополнительно.

**Производство:** Made in Italy — HAIR LOVE COMPANY, Viterbo, Italy
**Владелец:** Павел (Израиль) — бренд, Instagram, сайт
**Партнёр:** Максим (Украина) — продажи, дистрибуторы, сертификация
**Instagram:** `@hair_love_company` | Business аккаунт ✅

### Продукты

| Продукт | Объёмы | pH | Ключевой состав |
|---|---|---|---|
| 20 IN 1 CREAM-SPRAY | 200/50/20 мл | 4.5–5.0 | кератин, масло арганы, шёлк, макадамия, пантенол |
| THERMO PROTECTOR | 200/50/20 мл | 4.5–5.0 | кератин, аминокислоты, экстракт винограда, авокадо |
| LIQUID LAMELLAR FILLER-MASK | 200/50/20 мл | 5.0–6.0 | кератин, коллаген, алоэ вера, протеин риса |
| SILK (Шовкова інфузія) | 30 мл | — | в испытаниях, скоро |

**Cream-Spray** — флагман, ~3500–4000 шт. продано. **Thermo** — 2-я партия 500 шт.
...
`deeply.com.ua` — минимализм | `jnowaprofessional.ua` — B2B | `hairsekta.com` — Pro-программа | `K18hair.com` — product-first дизайн | `Olaplex.com` — education
