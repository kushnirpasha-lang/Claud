...
### Продукты HairLove
- **Крем-спрей 20 в 1** — несмываемый уход, термозащита, укладка (в продаже)
- **Термозащита** — спрей (в продаже)
- **Ламинарная вода** — ламинирование дома, зеркальный блеск (в продаже)
- **Шелк** — в испытаниях, скоро выход
