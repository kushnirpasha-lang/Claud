...
const AGENTS = {
  strategy: {
    ...
    updated:'04.05.2026 18:56',
    done:[
      {t:'Таблица цен: 9 SKU, 4 уровня (дистр/салон/РРЦ мастер/РРЦ интернет)', d:'04.05.2026 15:30'},
      {t:'Структура сайта: 5 страниц, B2B витрина', d:'04.05.2026 15:30'},
      {t:'Instagram: 6 рубрик с частотой и форматами', d:'04.05.2026 15:30'},
      {t:'Дорожная карта: 3 этапа, роли Павел/Максим', d:'04.05.2026 15:30'},
      {t:'Продажи: крем-спрей ~3500-4000 шт., термозащита 2-я партия', d:'04.05.2026 15:30'},
    ],
  ...
  texts: {
    ...
    updated:'04.05.2026 18:56',
      ...
      {t:'База знаний: составы, pH, объёмы всех 4 продуктов', d:'04.05.2026 16:10'},
      {t:'Голос бренда: живой, тёплый, экспертный', d:'04.05.2026 16:10'},
      {t:'Список запрещённых слов и шаблонов', d:'04.05.2026 16:10'},
      {t:'Форматы: Instagram, сайт, реклама, email', d:'04.05.2026 16:10'},
    ],
  ...
  competitors: {
    ...
    updated:'04.05.2026 18:56',
      ...
      {t:'deeply.com.ua: минимализм, простые составы', d:'04.05.2026 15:30'},
      {t:'jnowaprofessional.ua: B2B, обучение', d:'04.05.2026 15:30'},
      {t:'hairsekta.com: Pro-программа (идея HairLove Pro)', d:'04.05.2026 15:30'},
      {t:'K18hair.com и Olaplex.com — международные ориентиры', d:'04.05.2026 15:30'},
    ],
    progress:[],
  ...
  insta: {
    ...
    updated:'04.05.2026 18:56',
      ...
      {t:'База знаний агента встроена напрямую в файл команды', d:'04.05.2026 18:10'},
    ],
  ...
  site: {
    ...
    updated:'04.05.2026 18:56',
      ...
      {t:'Структура: 5 страниц в стратегии', d:'04.05.2026 15:30'},
      {t:'Дизайн-требования: цвет, шрифт, mobile-first', d:'04.05.2026 15:30'},
      {t:'Tilda (витрина) vs Shopify (магазин) — сравнение', d:'04.05.2026 15:30'},
      {t:'База знаний агента встроена напрямую в файл команды', d:'04.05.2026 18:10'},
    ],
